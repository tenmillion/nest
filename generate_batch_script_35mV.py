# generate_batch_script_35mV.py
# Script for generating bash files
# For the new simulation conditions
# For low phi with threshold set to 35mV (changed in main script)
# Python 2.7
...
phi = np.array([5*3**((k-37)/10.) for k in np.arange(10,41,3)])[:5] # temperature
print phi
